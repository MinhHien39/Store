...
Codebase nay duoc tao tu source `store` voi huong:
...
- `backend/`: Backend tu source store (giu nguyen de tai su dung API pattern).
...
- `environment/`: Bien moi truong local/dev/prd cho Store.
...
=======
- Backend hien duoc copy nguyen tu store de bao toan architecture va convention.
